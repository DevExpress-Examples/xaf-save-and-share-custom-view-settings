...
public sealed class ViewSettingsEFModule : ModuleBase {
    public ViewSettingsEFModule() {
		// 
		// ViewSettingsEFModule
		// 
		AdditionalExportedTypes.Add(typeof(ViewSettingsEF.Module.BusinessObjects.ApplicationUser));

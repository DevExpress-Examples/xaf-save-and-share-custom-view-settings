    ...
    Public Class ViewVariantsController
        ...
        Private Sub SelectViewVariantAction_Execute(ByVal sender As Object, ByVal e As SingleChoiceActionExecuteEventArgs)
            ...
            If currentItem.Data IsNot Nothing Then
                If Me.TryLoadViewVariantFromXML(CType(currentItem.Data, SettingsStore).Xml) Then
        ...
        Private Sub UpdateCurrentViewVariantAction_Execute(ByVal sender As Object, ByVal e As SimpleActionExecuteEventArgs)
            Me.SaveViewVariantToXML(TryCast(SelectViewVariantAction.SelectedItem.Data, SettingsStore))
        End Sub
        ...
        Protected Overrides Sub OnActivated()
            MyBase.OnActivated()
            Me.View.ModelSaving += AddressOf View_ModelSaving
        ...
        Public Sub New()
            ...
            DeleteViewVariantAction.Execute += New SimpleActionExecuteEventHandler(AddressOf Me.DeleteViewVariantAction_Execute)
            CreateViewVariantAction = New PopupWindowShowAction(Me, "SaveAsNewViewVariant", "Edit")
            CreateViewVariantAction.CustomizePopupWindowParams += New CustomizePopupWindowParamsEventHandler(AddressOf Me.CreateViewVariantAction_CustomizePopupWindowParams)
            CreateViewVariantAction.Execute += New PopupWindowShowActionExecuteEventHandler(AddressOf Me.CreateViewVariantAction_Execute)
            ...
            SelectViewVariantAction.Execute += New SingleChoiceActionExecuteEventHandler(AddressOf Me.SelectViewVariantAction_Execute)
            UpdateCurrentViewVariantAction = New SimpleAction(Me, "UpdateCurrentViewVariant", "Edit")
            UpdateCurrentViewVariantAction.Execute += New SimpleActionExecuteEventHandler(AddressOf Me.UpdateCurrentViewVariantAction_Execute)
            UpdateDefaultSettingsWithSelectedVariantAction = New SimpleAction(Me, "UpdateDefaultViewVariant", "Edit")
            Me.UpdateDefaultSettingsWithSelectedVariantAction.Execute += AddressOf UpdateDefaultSettingsWithSelectedVariantAction_Execute

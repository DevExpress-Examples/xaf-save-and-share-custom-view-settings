...
Namespace ViewSettings.Win
    ...
    Public Class ViewSettingsWindowsFormsApplication
        ...
        Public Sub New()
            ...
            DatabaseVersionMismatch += AddressOf ViewSettingsWindowsFormsApplication_DatabaseVersionMismatch
            CustomizeLanguagesList += AddressOf ViewSettingsWindowsFormsApplication_CustomizeLanguagesList
        End Sub

        Private Sub ViewSettingsWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub ViewSettingsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
